...
class DiscussionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create discussion" do
    assert_difference('Discussion.count') do
      post discussions_url, params: { discussion: { account_id: @discussion.account_id, body: @discussion.body, title: @discussion.title } }
    end
  ...
  test "should update discussion" do
    patch discussion_url(@discussion), params: { discussion: { account_id: @discussion.account_id, body: @discussion.body, title: @discussion.title } }
